...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, resizable.js, sortable.js, autocomplete.js, button.js, datepicker.js, dialog.js, menu.js, selectmenu.js, tooltip.js
...
if ($.datepicker) {
    $.datepicker._gotoToday = function(id) {
        ...
        if (this._get(inst, 'gotoCurrent') && inst.currentDay) {
            nst.selectedDay = inst.currentDay;
            nst.drawMonth = inst.selectedMonth = inst.currentMonth;
            nst.drawYear = inst.selectedYear = inst.currentYear;
        } else {
            var date = new Date();
    ...
    $.datepicker.parseDate = function(format, value) {
        var useStrictParsing = false;
        var date = window.moment(value, format, useStrictParsing).toDate();
        return date;
    };
